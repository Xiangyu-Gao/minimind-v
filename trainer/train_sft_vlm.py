...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--save_weight", default="sft_vlm", type=str, help="保存权重的前缀名"
    )
    ...
    parser.add_argument(
        "--data_path",
        type=str,
        default="../dataset/sft_data.jsonl",
        help="训练数据路径",
    )
    parser.add_argument(
        "--images_path", type=str, default="../dataset/sft_images", help="训练图像路径"
    )
    parser.add_argument(
        "--from_weight",
        default="pretrain_vlm",
        type=str,
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="MiniMind-V-SFT", help="wandb项目名"
    )
